    ...
    <div className='main-details p-[100px] flex justify-center items-start'>
      <div className="main-details-images">
        <div className="main-details-main-img md:w-1/2">
            <Image src={mainImg} alt="main-img" width={2200} height={1080} />
        </div>
        <div className="main-details-choices flex"></div>
            <div className="flex gap-3">
                <Image className='block my-2 max-w-1/2' src={choice1img} alt="main-img" width={300} height={200} />
                <Image className='block my-2 max-w-1/2' src={choice2img} alt="main-img" width={300} height={200} />
            </div>
            <div className="flex gap-3">
                <Image className='block my-2 max-w-1/2' src={choice3img} alt="main-img" width={300} height={200} />
                <Image className='block my-2 max-w-1/2' src={choice4img} alt="main-img" width={300} height={200} />
            </div>
      </div>
