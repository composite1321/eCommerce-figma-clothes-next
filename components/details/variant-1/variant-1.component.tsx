    ...
    <div className='main-details p-[100px] flex justify-center items-start'>
      <div className="main-details-images">
        <div className="main-details-main-img md:w-1/2">
            <Image src={mainImg} alt="main-img" width={1920} height={1080} />
        </div>
        <div className="main-details-choices"></div>
            <Image className='block my-2' src={choice1img} alt="main-img" width={600} height={200} />
            <Image className='block my-2' src={choice2img} alt="main-img" width={600} height={200} />
            <Image className='block my-2' src={choice3img} alt="main-img" width={600} height={200} />
            <Image className='block my-2' src={choice4img} alt="main-img" width={600} height={200} />
      </div>
